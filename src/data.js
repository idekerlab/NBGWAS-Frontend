const data = {
    ...
    text: {
        ...
        ndex: 'Network UUID (default: f93f402c-86d4-11e7-a10d-0ac135e8bacf)',
    ...
    help: {
        ...
        ndex: 'NDEx (http://www.ndexbio.org) UUID of network to load. For example, to use the Parsimonious ' +
            'Composite Network (PCNet), one would use this: f93f402c-86d4-11e7-a10d-0ac135e8bacf',
